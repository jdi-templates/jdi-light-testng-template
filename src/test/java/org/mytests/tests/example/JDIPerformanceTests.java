...
public class JDIPerformanceTests extends SimpleTestsInit {
    ...
    public void fillContactFormTest() {
        ...
        contactForm.submit(DEFAULT_CONTACTS);
        contactForm.check(DEFAULT_CONTACTS);
    }

    @Test
    public void hugeTableSearchTest() {
        StopWatch timer = StopWatch.createStarted();
        /*performancePage.table.assertThat().hasRowsWhereValue(
                $(containsString("Meyer"), inColumn("Name")),
                $(containsString("co.uk"), inColumn("Email")));
        */
